...
## 検索機能
画面上部の入力フォームに検索したいワードを入力してください。
入力後、検索ボタンを押すと検索結果一覧画面に移動します。

![検索](https://user-images.githubusercontent.com/69387339/101151071-7b686200-3664-11eb-844a-66c378264ae6.gif)
